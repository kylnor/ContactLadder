...
> "I switched from Top Producer with 3,000 contacts. I dreaded the migration. Turns out, I exported a CSV from Top Producer, imported into Cloze, and was up and running in 20 minutes. The field mapping was intuitive, duplicates merged automatically, and I didn't lose a single contact."
...
> "Import gets your contacts INTO Cloze. Email and phone sync fills in the RELATIONSHIP HISTORY. Combined, you get a complete picture of everyone you know."
...
**Data Cleanup Tips Before Import:**

- Remove blank rows
- Fix any obvious typos in names
- Standardize phone number formats (Cloze handles various formats, but consistency helps)
- Check for duplicate rows (same email appearing twice)
- Remove any test contacts or placeholder data
...
- A: Cloze supports multiple emails per contact. In your CSV, you can have Email1, Email2, Email3 columns. Map each to "Email Address" and Cloze will add all three.
...
| Version | Audience | Hook |
|---------|----------|------|
| A | Needs backup | "Your database is your business. Export it monthly for backup, so you're never at the mercy of one platform." |
| B | Needs mailing list | "Want to send holiday cards, postcards, or use a mail merge tool outside Cloze? Export your contacts with addresses." |
| C | Compliance / broker request | "Your broker wants a list of your clients, or you need to comply with data requests. Export gives you exactly what you need in seconds." |
...
**You've completed Module 0E: Import & Export Contacts!**

**What you now know:**

✅ How to prepare a CSV file for import
✅ How to import contacts from Excel, CSV, or other CRMs
✅ How to map fields correctly during import
✅ How to handle duplicates
✅ How to export contacts for backup or mailing lists
...
- Don't stress about perfect data on import. You'll clean it up as you go.
- Use the "merge duplicates" feature liberally - Cloze is smart about matching.
- After importing, give Cloze 24 hours to sync email/phone history for those contacts.
- Most agents import once (initial setup), then rely on email/phone sync to add new contacts automatically.
